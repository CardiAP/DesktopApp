...
class AnalysisInputParametersForm(QWidget):
    ...
    def parametrization(self):
        min_dist = self._from_string_to_int_or_none(self._min_dist_input.text())
        calibration = self._from_string_to_int_or_none(self._calibration_input.text())
        slice_width = self._from_string_to_int_or_none(self._slice_width_input.text())
